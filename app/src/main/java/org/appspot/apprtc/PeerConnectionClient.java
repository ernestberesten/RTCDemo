...
public class PeerConnectionClient {
  ...
  protected static final String VIDEO_H264_MAIN_PROFILE_FIELDTRIAL = "WebRTC-H264MainProfile/Enabled/";
  ...
  public void createPeerConnection(final EglBase.Context renderEGLContext,
                                   final VideoSink localRender, final VideoSink remoteRender,
  ...
  public void createPeerConnection(final EglBase.Context renderEGLContext,
      final VideoSink localRender, final List<VideoSink> remoteRenders,
      final VideoCapturer videoCapturer, final SignalingParameters signalingParameters) {
...
//    MediaCodecVideoEncoder.setEglContext(renderEGLContext);
//    videoEncoderFactory = MediaCodecVideoEncoder.createFactory();
    videoEncoderFactory = new DefaultVideoEncoderFactory(renderEGLContext, false, true);
    VideoDecoderFactory videoDecoderFactory;
//    MediaCodecVideoDecoder.setEglContext(renderEGLContext);
//    videoDecoderFactory = MediaCodecVideoDecoder.createFactory();
    videoDecoderFactory = new DefaultVideoDecoderFactory(renderEGLContext);
    ...
    executor.execute(new Runnable() {
      ...
      public void run() {
        if (videoCapturer != null && videoCapturerStopped) {
          ...
          SurfaceTextureHelper helper = SurfaceTextureHelper.create("SurfaceTextureHelper", renderEGLContext);
      ...
      executor.execute(new Runnable() {
        ...
        public void run() {
          ...
          if (stream.videoTracks.size() == 1) {
            ...
            remoteVideoTrack.setEnabled(renderVideo);
            for (VideoSink remoteRender : remoteRenders) {
